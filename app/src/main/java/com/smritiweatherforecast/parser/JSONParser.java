...
public class JSONParser {
    ...
    public static DailyWeatherForecast getForecastWeather(String data) throws JSONException {
        ...
        for (int i = 0; i < jArr.length(); i++) {
            ...
            DayWiseWeatherForecast df = new DayWiseWeatherForecast();
            ...
            df.temperatureForecast.day = (float) jTempObj.getDouble("day");
            df.temperatureForecast.min = (float) jTempObj.getDouble("min");
            df.temperatureForecast.max = (float) jTempObj.getDouble("max");
            df.temperatureForecast.night = (float) jTempObj.getDouble("night");
            df.temperatureForecast.eve = (float) jTempObj.getDouble("eve");
            df.temperatureForecast.morning = (float) jTempObj.getDouble("morn");
